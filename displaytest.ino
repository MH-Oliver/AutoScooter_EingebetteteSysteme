...
int spannungseingang = 35;
int displayeingang = 34;
int displayscore = 100;
...
pinMode(spannungseingang, INPUT);
...
int gemessenerStrom = digitalRead(spannungseingang);
Serial.println(gemessenerStrom);
